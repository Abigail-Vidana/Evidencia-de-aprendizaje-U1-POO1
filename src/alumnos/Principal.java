...
Se debe considerar que cada grupo no sobrepasa los 30 alumnos. Cada docente debe 
promediar su materia en particular con base al 100% de calificación, tomando en 
cuenta para cada una de las tres unidades: la asistencia (10%), participación (10%), 
tareas presentadas (30%) y el exámen (50%). Se requiere que el programa visualice 
los datos generales del alumno (Nombre, apellido, matrícula, grado, grupo, nombre 
de la escuela, nombre del docente y materia que cursa) y obtener el promedio de 
la materia; además, presentar el total de alumnos que han aprobado y reprobado el curso.*/
